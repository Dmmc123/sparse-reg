...
def mean_squared_error(y_hat: Tensor, y_true: Tensor, w: Tensor = None) -> Tensor:
    """
...
def lasso(y_hat: Tensor, y_true: Tensor, w: Tensor) -> Tensor:
    """
...
def ridge(y_hat: Tensor, y_true: Tensor, w: Tensor) -> Tensor:
    """
